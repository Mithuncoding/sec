      ...
      <header className="bg-bg-surface border-b border-border-strong p-4 flex items-center justify-between shadow-hud z-20">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex flex-col items-end text-right mr-4">
            ...
            <span className={`text-xs font-bold max-w-[200px] truncate ${threatLevel > 50 ? 'text-danger' : 'text-success'}`}>
              {threatAnalysis}
            </span>
          </div>
                  ...
                  <div className={`max-w-[70%] ${msg.sender === role ? 'items-end' : 'items-start'} flex flex-col`}>
                    ...
                    >
                      ...
                      <div className="text-sm leading-relaxed whitespace-pre-wrap font-mono">
                        <DecryptedText text={msg.isEncrypted ? decryptMessage(msg.text) : msg.text} speed={20} />
                      </div>
                    </div>
                  </div>
                </motion.div>
